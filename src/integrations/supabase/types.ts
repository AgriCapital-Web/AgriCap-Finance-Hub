  ...
  public: {
    Tables: {
      associate_contributions: {
        ...
        Relationships: [
          {
            foreignKeyName: "associate_contributions_associate_id_fkey"
          ...
          {
            foreignKeyName: "associate_contributions_transaction_id_fkey"
      ...
      transactions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "transactions_associate_id_fkey"
            columns: ["associate_id"]
            isOneToOne: false
            referencedRelation: "associates"
            referencedColumns: ["id"]
